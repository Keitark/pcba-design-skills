...
| [`pcb-layout-review`](.agents/skills/pcb-layout-review/SKILL.md) | 部品配置、配線、基準面、DRC、機構、DFM | `layout-review.json`, 実験台帳 |
...
| [`operate-jlcpcb-order`](.agents/skills/operate-jlcpcb-order/SKILL.md) | JLCPCB 見積、部品割当、実装プレビュー、費用、承認 | 配置・見積・発注記録 |
